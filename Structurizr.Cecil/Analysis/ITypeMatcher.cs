...
namespace Structurizr.Analysis
{
    ...
    {
        /// <summary>
        /// Checks the given <see cref="TypeDefinition"/> matches against the component identification rule.
        /// </summary>
        /// <param name="type">The <see cref="TypeDefinition"/> of the type to match.</param>
